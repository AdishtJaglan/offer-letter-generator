...
const createDashboard = async (adminName, adminId) => {
  ...
  (0,_handleDashboard__WEBPACK_IMPORTED_MODULE_6__.reloadPage)();
...
const handleLogin = () => {
  ...
  loginForm.addEventListener("submit", async (e) => {
    ...
    try {
      loginBtn.innerHTML = `
      <img src="${_images_spinner_gif__WEBPACK_IMPORTED_MODULE_2__["default"]}" style="width: 25px;"/>
    `;
